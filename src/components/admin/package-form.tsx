...
export function PackageForm({
  ...
  async function handleOptionMediaUploadBatch(
    optionKey: string,
    files: File[],
  ) {
    ...
    for (const file of files) {
      ...
      await handleOptionMediaUpload(optionKey, file, mediaType);
    }
  }
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid-safe grid gap-3">
                      <AdminFileUpload
                        ...
                        onFilesSelect={(files) =>
                          void handleOptionMediaUploadBatch(key, files)
                        }
                        onFileSelect={(file) =>
                          void handleOptionMediaUploadBatch(key, [file])
                        }
                      />
                    </div>
                  </div>
